# Telegram-Handler
A userbot-powered Python program made using Telethon, allowing users to manage across multiple Telegram groups in their Python terminal using simple command syntax.
